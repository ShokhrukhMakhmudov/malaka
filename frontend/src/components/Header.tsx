...
export default function Header() {
  return (
    <header
      className={`w-full fixed z-[100] top-0 header text-background font-montMed shadow-lg border-b-2 border-white transition-all duration-300 backdrop-blur-3xl`}
    >
